...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        self.heading = tkinter.Label(
            master, text="Faculty Registration",  fg='steelblue', font=('arial 40 bold'))
        self.heading.place(x=450, y=0)

        # labels
        self.roll_l = tkinter.Label(
            master, text="Enter Faculty's Roll Number", font=('arial 18 bold'))
        self.roll_l.place(x=0, y=100)

        self.name_l = tkinter.Label(
            master, text="Enter Faculty's Name", font=('arial 18 bold'))
        self.name_l.place(x=0, y=200)

        self.sub_l = tkinter.Label(
            master, text="Enter Faculty's Subject", font=('arial 18 bold'))
        self.sub_l.place(x=0, y=300)

        self.phone_l = tkinter.Label(
            master, text="Enter Faculty's Phone", font=('arial 18 bold'))
        ...
        self.btn_add = tkinter.Button(
            master, text="ADD", width=20, height=2, bg='steelblue', command=self.write_fac)

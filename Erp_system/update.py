...
class Database:
    def __init__(self , master , *args , **kwargs):
        ...
        self.master= master
        # heading label
        self.heading = tkinter.Label(master, text="Student Attendance Update",  fg='steelblue', font=('arial 40 bold'))
        ...
        self.attend_e.place(x=200 , y=600)
         ...
         # update db button
        self.btn_add = tkinter.Button(master, text="Update", width=20, height=2, bg='steelblue', command = self.update)
